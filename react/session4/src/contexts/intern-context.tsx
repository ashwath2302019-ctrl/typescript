...
// represent different responsibilities. Components that only need the
// theme should not depend on intern data, and components that only need
// intern data should not depend on the theme. This keeps the code
// organized and avoids unnecessary re-renders when unrelated data changes.