...
/*
Without useMemo, the stats would be calculated every time the component
re-renders, even if the interns list has not changed. This causes
unnecessary calculations and can reduce performance, especially when
