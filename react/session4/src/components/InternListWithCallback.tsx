...
/*
useCallback remembers the same function between renders unless its
dependencies change. This helps prevent creating a new function on
every render, which can avoid unnecessary re-renders of child
components that receive the function as a prop.
*/